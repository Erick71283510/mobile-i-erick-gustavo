...
export default function App() {
  ...
  const subjects = [
    { name: 'Matemática', grade: 8.5, absences: 2, classesHeld: 6, mention: 'Bom' },
    { name: 'Português', grade: 9.0, absences: 0, classesHeld: 8, mention: 'Ótimo' },
    { name: 'História', grade: 7.0, absences: 0, classesHeld: 2, mention: 'Regular' },
    { name: 'Ciências', grade: 8.0, absences: 0, classesHeld: 1, mention: 'Bom' },
  ];
